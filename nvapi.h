...
typedef struct _NV_GPU_DISPLAYIDS
{
    ...
    NvU32    reserved: 26;              //!< must be zero
} NV_GPU_DISPLAYIDS;
...
//! \param [out]     pTopoStatus        The array of problems and warnings with each grid topology.
...
NVAPI_INTERFACE NvAPI_Mosaic_ValidateDisplayGrids(__in NvU32 setTopoFlags,
        ...
        __out_ecount_full(gridCount) NV_MOSAIC_DISPLAY_TOPO_STATUS *pTopoStatus,
...
//! \param [out]  gsyncGpuCount-      It returns number of GPUs connected to Sync device
//! \param [out]  gsyncGPUs-          It returns info about GPUs connected to Sync device
//! \param [out]  gsyncDisplayCount-  It returns number of active displays that belongs to Sync device
//! \param [out]  gsyncDisplays-      It returns info about all active displays that belongs to Sync device
//!
...
//! \retval ::NVAPI_NVIDIA_DEVICE_NOT_FOUND		The queried Graphics system does not have any Sync Device.
//! \retval ::NVAPI_INVALID_SYNC_TOPOLOGY       If gsync topology displays doesn't match the displays in currently set mosaic topology.
//!
//! \ingroup gsyncapi
///////////////////////////////////////////////////////////////////////////////
...
typedef struct _NV_GSYNC_CONTROL_PARAMS
{
	...
	NV_GSYNC_DELAY              syncSkew;           //!< The time delay between the frame sync signal and the GPUs signal. Not supported, for future use.
    NV_GSYNC_DELAY              startupDelay;       //!< The amount of time the frame lock card should wait until generating sync pulse. Not supported, for future use.
